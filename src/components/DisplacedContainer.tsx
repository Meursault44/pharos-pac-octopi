...
import { Container as PixiContainer, Sprite as PixiSprite, DisplacementFilter, Assets, Texture } from 'pixi.js';
...
export const DisplacedContainer = ({
    ...
    const filter = useMemo(() => {
        ...
        f.padding = 0;
        return f;
    }, [spriteRef.current]); // не вешаем scale сюда, чтобы не пересоздавать фильтр
